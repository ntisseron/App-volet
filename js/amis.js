...
function sendVoletApiRequest(isChecked) {
    const urlOpen = 'http://192.168.0.49/core/api/jeeApi.php?apikey=WPsynhMvFe6gLnEkWmqXcM3Jv66g84lm&type=cmd&id=490'; // API volet ouvert
    const urlClose = 'http://192.168.0.49/core/api/jeeApi.php?apikey=WPsynhMvFe6gLnEkWmqXcM3Jv66g84lm&type=cmd&id=491'; // API volet fermé
...
function sendLightApiRequest(isChecked) {
    const urlOn = 'http://192.168.0.49/core/api/jeeApi.php?apikey=WPsynhMvFe6gLnEkWmqXcM3Jv66g84lm&type=cmd&id=491'; //API pour allumer la lumière
    const urlOff = 'http://192.168.0.49/core/api/jeeApi.php?apikey=WPsynhMvFe6gLnEkWmqXcM3Jv66g84lm&type=cmd&id=490'; //API pour éteindre la lumière
